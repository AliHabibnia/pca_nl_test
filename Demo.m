...
%{
the "linear example" in Ref: Uwe Kruger, Junping Zhang, Lei Xie (2008)
...
%{
the "nonlinear example" in Ref: Uwe Kruger, Junping Zhang, Lei Xie (2008)
Developments and applications of nonlinear principal component analysis – a review
...
%{
the "nonlinear example" in Ref: Uwe Krugerو David Antory, Juergen Hahn, George W. Irwin, Geoff McCullough (2005)
